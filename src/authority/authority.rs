...
///
/// Diverging from [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986#section-3.2), the port is
/// required and user-info is not supported. For optional ports and user-info, see the
/// [web-url](https://crates.io/crates/web-url) crate.
#[must_use]
